            ...
            <div className="col-lg-7 col-md-6">
              <div className="product-detail-txt">
                ...
                <div className="purchase-item-point">
                  <p>
                    <RiAwardFill /> Purchase this item and get{" "}
                    <strong>5-8 Points</strong> - a worth of{" "}
                    <span>$0.50-$0.80</span>
                  </p>
                </div>
                ...
                <div className="sku-categories-tags">
                  ...
                  <p className="product-tags">
                    Tags: <a href="#">2023</a>, <a href="#">Ariel</a>,{" "}
                    <a href="#">Little Mermaid</a>
                  </p>
                </div>
              </div>
            </div>
                ...
                <Tabs>
                  ...
                  <TabPanel>
                    <div className="description-tab-text">
                      ...
                      <p>
                        This listing includes the 2023 Mermaid Princess &
                        ...
                        post are for inspiration purposes only.
                      </p>
                      <p>
                        The zipped file includes a color layout (sequence
                        chart), as well as the following formats:
                      </p>
                      <p>
                        DST, EXP, HUS, JEF, JEF+, PES, VIP, VIP3, XXX, & SEW
                      </p>
                      <p>
                        If there is a different file format needed, please
                        message the seller.
                      </p>
                      <p>
                        All vinyl used in the stock photos is from{" "}
                        <a href="">Sweet n Sassy Blanks & Such.</a>
                      </p>
                      <h6>
                        ***These designs are in no way affiliated with any other
                        characters and their resemblance to any is merely
                        coincidental***
                      </h6>
                    </div>
                  </TabPanel>
