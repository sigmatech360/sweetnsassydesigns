    ...
    if (name == "downloadable") {
      ...
      setVariations((prev) => {
        ...
        if(updated[index].downloadable == 1){
          updated[index] = { ...updated[index], downloadableFiles :  [{ name: "", url: "" }]}
        }
  ...
  const handleDownloadableFileUpload = (e, index, ind) => {
    ...
    if(file){
      ...
      setVariations((prev) => {
        ...
        console.log('updatedDownloadableFiles of index',index, ind, updatedDownloadableFiles[ind]);
        updated[index].downloadableFiles = updatedDownloadableFiles;
        return updated;
      });
      setIsSaved(false);
                            ...
                            <>
                              <div className=" d-flex align-items-start gap-3 border-top border-bottom pt-2">
                                ...
                                <input
                                  ...
                                  name="file"
                                  onChange={(e) =>
                                    handleDownloadableFileUpload(e, index, ind)
                                  }
                                  hidden
                                />
